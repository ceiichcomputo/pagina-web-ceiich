<?php
/**
 * The template for kinfw team member custom post type with no sidebar layout.
 *
 */
...
if( 'theme_post_style' === $post_style ) {
    $post_style = kinfw_onnat_theme_options()->kinfw_get_option( 'single_kinfw_team_member_style' );
