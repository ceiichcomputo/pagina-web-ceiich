 ...
 *
 * The template for post with right sidebar layout.
 */
get_header();
...
if( 'style-1' === $post_style ) {
    get_template_part( 'template-parts/single-post/style-1/content', 'right' );
} else if ( 'style-2' === $post_style ) {
    get_template_part( 'template-parts/single-post/style-2/content', 'right' );
} else {
    get_template_part( 'template-parts/single-post/elementor-template/content', 'right', [ 'template_id' => $post_style ]);
}
