<?php
/**
 * The template part for displaying kinfw-team-member in grid style 1.
 *
 */
$post_id    = get_the_ID();
...
<div class="<?php echo esc_attr( $args['classes'] );?>">
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'kinfw-team-member-grid-style-1 kinfw-team-member-item' ); ?>>
        <?php
