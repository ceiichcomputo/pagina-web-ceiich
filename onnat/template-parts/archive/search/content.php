<?php
/**
 * The template part for displaying the search result posts.
 *
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'kinfw-search-result kinfw-post-item' ); ?>>

    <div class="kinfw-entry-content-wrap">

        <?php
            printf( '<div class="kinfw-entry-count">%1$s</div>', $args['count'] );
        ?>
