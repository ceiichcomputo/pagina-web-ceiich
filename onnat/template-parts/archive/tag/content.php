<?php
/**
 * The template part for displaying posts in tag archive.
 *
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'kinfw-category-archive kinfw-tag-archive kinfw-post-item' ); ?>>
    <?php
