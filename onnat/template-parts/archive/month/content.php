<?php
/**
 * The template part for displaying posts in month archive.
 *
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'kinfw-date-archive kinfw-post-item' ); ?>>

    <div class="kinfw-entry-date-wrap">
        <?php printf(
            '<time datetime="%1$s">
                <span>%2$s</span><span>%3$s</span>
            </time>',
