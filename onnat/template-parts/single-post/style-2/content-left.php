<?php
/**
 * The template for displaying post content in style-2 with left sidebar layout.
 */
...
$class = count( $sidebars ) ? 'kinfw-single-post-style-2 kinfw-has-sidebar kinfw-sidebar-left' : 'kinfw-single-post-style-2 kinfw-has-no-sidebar';
?>
<!-- #kinfw-main-content -->
