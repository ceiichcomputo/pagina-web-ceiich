<?php
/**
 * The template for displaying post content in style-1 with left sidebar layout.
 */
...
$class = count( $sidebars ) ? 'kinfw-has-fw-section kinfw-single-post-style-1 kinfw-has-sidebar kinfw-sidebar-left' : 'kinfw-has-fw-section kinfw-single-post-style-1 kinfw-has-no-sidebar';
?>
