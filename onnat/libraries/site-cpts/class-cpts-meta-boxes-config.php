...
if( ! class_exists( 'Onnat_Theme_Our_CPT_Meta_Boxes' ) ) {

    /**
     * The Onnat Our CPT Meta Boxes setup class.
     */
    class Onnat_Theme_Our_CPT_Meta_Boxes {
        ...
        public function __construct() {
            ...
            $this->template_meta_box();
            $this->option_meta_box();

            do_action( 'kinfw-action/theme/meta-boxes/our/cpt/loaded' );
        }

        /**
         * Meta Box for Template Options
         * Layout Options: No Sidebar, Left and Right Sidebar
         */
        public function template_meta_box() {
            CSF::createMetabox( '_kinfw_cpt_template', [
                'title'          => esc_html__( 'Template Layout Option', 'onnat' ),
                'post_type'      => apply_filters( 'kinfw-filter/theme/metabox/template/post-type', [] ),
                'context'        => 'side',
                'page_templates' => [ 'kinfw-cpt-templates/left-sidebar.php', 'kinfw-cpt-templates/right-sidebar.php' ],
            ] );

                CSF::createSection( '_kinfw_cpt_template', [
                    'fields' => [
                        [
                            'id'          => 'sidebars',
                            'type'        => 'select',
        ...
        /**
         * Meta Box for Template Settings
         * Settings: Header, Title and Footer
         */
        public function option_meta_box() {
            CSF::createMetabox( '_kinfw_cpt_options', [
                'title'     => esc_html__( 'Template Options', 'onnat' ),
                'post_type' => apply_filters( 'kinfw-filter/theme/metabox/template/post-type', [] ),
                'context'   => 'normal',
                'priority'  => 'default'
            ] );
            ...
            CSF::createSection( '_kinfw_cpt_options', [
                ...
                'fields' => [
                    [
                        ...
                        'type'    => 'switcher',
                        'desc'    => esc_html('Use this option to define a personalized theme or skin for this specific item.', 'onnat' ),
                        'default' => false,
                    ],
                    [
...
if( !function_exists( 'kinfw_onnat_theme_our_cpt_meta_boxes' ) ) {

    /**
     * Returns the instance of a class.
     */
    function kinfw_onnat_theme_our_cpt_meta_boxes() {

        return Onnat_Theme_Our_CPT_Meta_Boxes::get_instance();
    }

}

kinfw_onnat_theme_our_cpt_meta_boxes();
