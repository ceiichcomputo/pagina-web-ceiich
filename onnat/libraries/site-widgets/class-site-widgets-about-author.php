...
if( ! class_exists( 'Onnat_Theme_Widget_About_Me' ) ) {

    /**
     * The Onnat Theme widgets setup class.
     */
    class Onnat_Theme_Widget_About_Me {
        ...
        public function __construct() {
            ...
            $this->widget_id        = 'onnat_widgets_about_me';
            $this->widget_title     = sprintf( esc_html_x( '%1$s About Me', 'admin-widget-view', 'onnat' ), ONNAT_CONST_THEME );
            $this->widget_desc      = esc_html_x( 'It provides a brief description or introduction to the website owner or author.', 'admin-widget-view', 'onnat' );
            $this->widget_css_class = 'kinfw-widgets kinfw-widget-about-me';
            ...
            CSF::createWidget( $this->widget_id, [
                ...
                'fields'      => [
                    ...
                    [
                        ...
                        'default' => [
                            'url'       => esc_url( get_theme_file_uri( 'assets/image/public/avatar.png' ) ),
                            'thumbnail' => esc_url( get_theme_file_uri( 'assets/image/public/avatar.png' ) ),
                            'alt'       => $this->blog_name,
                    ...
                    [
                        ...
                        'url'     => false,
                        'library' => 'image',
                        'title'   => esc_html_x( 'Signature', 'admin-widget-field-view', 'onnat' ),
                        'default' => [
                            'url'       => esc_url( get_theme_file_uri( 'assets/image/public/signature.png' ) ),
                            'thumbnail' => esc_url( get_theme_file_uri( 'assets/image/public/signature.png' ) ),
                            'alt'       => $this->blog_name,
                            'title'     => $this->blog_name,
                        ]
                    ],
        ...
        public function widget ( $args, $instance ) {
            ...
            if( !empty( $media['url'] ) ) {
                ...
                printf(
                    '<div class="kinfw-widgets-about-me-avatar">
            ...
            if( !empty( $media['url'] ) ) {
                ...
                printf(
                    '<div class="kinfw-widgets-about-me-sign">
                        <img src="%1$s" alt="%2$s" title="%3$s"/>
                    </div>',
                    esc_url( $media['url'] ),
                    !empty( $alt ) ? $alt : $this->blog_name,
...
if( !function_exists( 'kinfw_onnat_theme_widget_about_me' ) ) {

    /**
     * Returns the instance of a class.
     */
    function kinfw_onnat_theme_widget_about_me() {

        return Onnat_Theme_Widget_About_Me::get_instance();
    }

}

kinfw_onnat_theme_widget_about_me();


if( !function_exists( 'onnat_widgets_about_me' ) ) {

    function onnat_widgets_about_me( $args, $instance ) {

        kinfw_onnat_theme_widget_about_me()->widget( $args, $instance );
    }
}
