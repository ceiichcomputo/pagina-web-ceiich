...
if( !class_exists( 'Onnat_Theme_WP_List_Pages_Nav_Menu_Mobile_Walker' ) ) {

    class Onnat_Theme_WP_List_Pages_Nav_Menu_Mobile_Walker extends Walker_Page {
        ...
        public function start_lvl( &$output, $depth = 0, $args = [] ) {
            ...
            $output .= "{$n}{$indent}<ul class='sub-menu sub-menu-hidden'>{$n}";
            $output .= '<li class="kinfw-mobile-menu-close"> <a href="javascript:void(0);"> '. kinfw_icon( 'math-cross' ) .' </a> </li>';
            $output .= '<li class="kinfw-mobile-menu-back"> <a href="javascript:void(0);"> '. kinfw_icon( 'arrows-simple-left') .' </a> </li>';
        }
        ...
        public function start_el( &$output, $data_object, $depth = 0, $args = [], $current_object_id = 0 ) {
            ...
            $class_names = explode(' ', $css_classes );
            $output .= in_array( "menu-item-has-children", $class_names ) ? '<span class="kinfw-sub-menu-trigger"> ' . kinfw_icon( 'arrows-simple-right' ) . ' </span>' : '';
