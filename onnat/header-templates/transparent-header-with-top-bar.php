...
if( !class_exists( 'Onnat_Theme_Transparent_Header_Top_Bar' ) ) {

	/**
	 * The Onnat Theme Transparent Header with Top Bar setup class.
	 */
    class Onnat_Theme_Transparent_Header_Top_Bar {
        ...
        public function build( $args ) {
			...
			if( 'header' === $args['header_type'] && 'top_bar_transparent_header' === $args['header_id'] ) {

				$full_width = kinfw_onnat_theme_options()->kinfw_get_option( 'top_bar_transparent_header_full_width');
				...
				printf( '<!-- #kinfw-masthead -->
					<header id="kinfw-masthead" class="kinfw-transparent-header kinfw-transparent-header-with-top-bar">
						%6$s
					...
					kinfw_onnat_theme_header()->menu_block( kinfw_onnat_theme_options()->kinfw_get_option( 'top_bar_transparent_header_menu' ), 'lg' ),
					...
					kinfw_onnat_theme_header()->menu_block( kinfw_onnat_theme_options()->kinfw_get_option( 'top_bar_transparent_header_menu' ), 'mobile' ),
				...
				switch( $action ) {
					...
					case 'hamburger-button':
						add_action( 'wp_footer', function(){
							$page_id = kinfw_onnat_theme_options()->kinfw_get_option( 'top_bar_transparent_header_icon_hamburger_button' );
		...
		public function tob_bar() {
			...
			$use_top_bar = kinfw_onnat_theme_options()->kinfw_get_option( 'top_bar_transparent_header');
...
if( !function_exists( 'kinfw_onnat_theme_transparent_header_top_bar' ) ) {

    /**
     * Returns the instance of a class.
     */
    function kinfw_onnat_theme_transparent_header_top_bar( $args ) {

        return Onnat_Theme_Transparent_Header_Top_Bar::get_instance( $args );
    }
}

kinfw_onnat_theme_transparent_header_top_bar( $args );
